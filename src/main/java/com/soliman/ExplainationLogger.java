...
public class ExplainationLogger implements Logger<String> {
    ...
    @Override
    public void log(int k, Set<String> open, Map<String, Set<Path<String>>> paths,
            DefaultDirectedWeightedGraph<String, LabeledEdge<Costs>> graph, Set<String> endNodes, String prescelto,
            Set<String> ND, Set<String> closed, Map<String, Set<Path<String>>> solutionCosts) {
        ...
        for (String node : open) {
            ...
            var NewF = String.join("", Moa.selectionFunction(graph, node, paths, endNodes).stream()
